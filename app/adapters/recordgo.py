...
class RecordGoAdapter(BaseAdapter):
    ...
    def _parse_acriss_vehicles(
        ...
        for product_data in products:
            ...
            vehicle_kwargs = {
                ...
                "provider_product_id": str(product_id) if product_id is not None else None,
                "provider_rate_id": str(rate_prod_ver) if rate_prod_ver not in (None, "") else None,
                "name": full_name,
    ...
    async def get_locations(self) -> list[dict]:
        ...
        """
        return [
            {"provider": self.supplier_id, "provider_location_id": "30001", "name": "Athens Airport", "country_code": "GR", "location_type": "airport", "iata": "ATH", "latitude": 37.892694, "longitude": 23.9},
            {"provider": self.supplier_id, "provider_location_id": "30002", "name": "Thessaloniki Airport", "country_code": "GR", "location_type": "airport", "iata": "SKG", "latitude": 40.5197, "longitude": 22.9709},
            {"provider": self.supplier_id, "provider_location_id": "30003", "name": "Zakynthos Airport", "country_code": "GR", "location_type": "airport", "iata": "ZTH", "latitude": 37.7509, "longitude": 20.8843},
            {"provider": self.supplier_id, "provider_location_id": "30004", "name": "Rhodes Airport", "country_code": "GR", "location_type": "airport", "iata": "RHO", "latitude": 36.4054, "longitude": 28.0862},
            {"provider": self.supplier_id, "provider_location_id": "34901", "name": "Tenerife South Airport", "country_code": "IC", "location_type": "airport", "iata": "TFS", "latitude": 28.0445, "longitude": -16.5725},
            {"provider": self.supplier_id, "provider_location_id": "34902", "name": "Las Palmas Airport", "country_code": "IC", "location_type": "airport", "iata": "LPA", "latitude": 27.9319, "longitude": -15.3866},
            {"provider": self.supplier_id, "provider_location_id": "34903", "name": "Lanzarote Airport", "country_code": "IC", "location_type": "airport", "iata": "ACE", "latitude": 28.9462, "longitude": -13.6052},
            {"provider": self.supplier_id, "provider_location_id": "34904", "name": "Chafiras", "country_code": "IC", "location_type": "other"},
            {"provider": self.supplier_id, "provider_location_id": "35001", "name": "Lisbon Airport", "country_code": "PT", "location_type": "airport", "iata": "LIS", "latitude": 38.788336, "longitude": -9.119148},
            {"provider": self.supplier_id, "provider_location_id": "35002", "name": "Faro Airport", "country_code": "PT", "location_type": "airport", "iata": "FAO", "latitude": 37.061687, "longitude": -7.967015},
            {"provider": self.supplier_id, "provider_location_id": "35003", "name": "Porto Airport", "country_code": "PT", "location_type": "airport", "iata": "OPO", "latitude": 41.23414, "longitude": -8.661691},
            {"provider": self.supplier_id, "provider_location_id": "39001", "name": "Palermo Airport", "country_code": "IT", "location_type": "airport", "iata": "PMO", "latitude": 38.1607, "longitude": 13.2919},
            {"provider": self.supplier_id, "provider_location_id": "39002", "name": "Catania Airport", "country_code": "IT", "location_type": "airport", "iata": "CTA", "latitude": 37.469939, "longitude": 15.068144},
            {"provider": self.supplier_id, "provider_location_id": "39003", "name": "Olbia Airport", "country_code": "IT", "location_type": "airport", "iata": "OLB", "latitude": 40.9, "longitude": 9.51},
            {"provider": self.supplier_id, "provider_location_id": "39004", "name": "Cagliari Airport", "country_code": "IT", "location_type": "airport", "iata": "CAG", "latitude": 39.253659, "longitude": 9.057523},
            {"provider": self.supplier_id, "provider_location_id": "39005", "name": "Rome Fiumicino Airport", "country_code": "IT", "location_type": "airport", "iata": "FCO", "latitude": 41.795153, "longitude": 12.242366},
            {"provider": self.supplier_id, "provider_location_id": "39006", "name": "Milan Bergamo Airport", "country_code": "IT", "location_type": "airport", "iata": "BGY", "latitude": 45.6689, "longitude": 9.7003},
        ]
