...
class WheelsysAdapter(BaseAdapter):
    ...
    def _parse_vehicle(
        ...
        vehicle_kwargs: dict = {
            ...
            "provider_product_id": group_code or None,
            "provider_rate_id": quote_id or None,
            "availability_status": availability_str.lower() if availability_str else ("available" if is_available else None),
            "name": name,
